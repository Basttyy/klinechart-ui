...
import { buyLimitStyle, takeProfitStyle } from '../../../store/overlaystyle/positionStyleStore'
...
const buyLimitProfitLine: OverlayTemplate = {
...
export default buyLimitProfitLine